...
function OrderModel(lineItemContainer, options) {
    ...
    if (!lineItemContainer) {
        ...
        this.shippable = null;
        this.storeId = null;  // add by me
        this.ccShippingStatus = null;  // add by me
    } else {
        ...
        this.storeId = Object.hasOwnProperty.call(lineItemContainer, 'storeId') // added by me
            ? lineItemContainer.storeId : null;

        this.CC_Status_Shipping = Object.hasOwnProperty.call(lineItemContainer, 'ccShippingStatus') // added by me
            ? lineItemContainer.ccShippingStatus : null;
